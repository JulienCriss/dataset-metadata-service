...
def test_filter_by_is_pii(api_client, customer, email, balance):
...
def test_filter_by_data_type(api_client, customer, email, balance):
...
def test_filter_by_pii_category(api_client, customer, email, balance):
...
def test_search_matches_the_description_too(api_client, customer, balance):
...
def test_an_unknown_data_type_is_rejected(api_client, customer, email):
...
def test_filters_do_not_escape_the_dataset(api_client, customer, order, email):
...
def test_filter_by_owner(api_client, customer, order):
...
def test_search_by_name(api_client, customer, order):
